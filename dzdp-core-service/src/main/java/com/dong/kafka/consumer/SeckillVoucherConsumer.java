...
import com.dong.service.IAutoIssueNotifyService;
...
public class SeckillVoucherConsumer extends AbstractConsumerHandler<SeckillVoucherMessage> {
    ...
    protected void afterConsumeFailure(final MessageExtend<SeckillVoucherMessage> message, 
        ...
        if (throwable instanceof HmdpFrameException dzdpFrameException) {
            if (Objects.nonNull(dzdpFrameException.getCode()) && 
                    dzdpFrameException.getCode().equals(BaseCode.VOUCHER_ORDER_EXIST.getCode())){
