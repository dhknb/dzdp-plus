...
import com.dong.exception.ArgumentError;
...
public class WebExceptionAdvice {
    ...
    public Result<String> toolkitExceptionHandler(HttpServletRequest request, HmdpFrameException dzdpFrameException) {
        log.error("业务异常 错误信息 : {} method : {} url : {} query : {} ", dzdpFrameException.getMessage(), request.getMethod(), getRequestUrl(request), getRequestQuery(request), dzdpFrameException);
        return Result.fail( dzdpFrameException.getMessage());
    }
    /**
     * 参数验证异常
     */
